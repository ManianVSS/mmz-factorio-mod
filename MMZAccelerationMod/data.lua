...
data.raw["logistic-container"]["logistic-chest-passive-provider"].inventory_size = 256
data.raw["logistic-container"]["logistic-chest-active-provider"].inventory_size = 256
